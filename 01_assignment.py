...
def exercise02():
    ...
    name = "Dan" # Variable name is set to Dan
...
def exercise03():
    ...
    sentence = "This is an arbitrary, 6 word sentence." # Variable sentence is set to a string that is a sentence.
...
def exercise04():
    ...
    # ------ Place code below here \/ \/ \/ ------
    first_name = "Dan"  # Two variables are created to hold a name.
    last_name = "Wigodsky"
    # ------ Place code above here /\ /\ /\ ------
...
def exercise05():
    ...
    first_name = "Dan"  # Two variables are created to hold a name.
    last_name = "Wigodsky"
    name_type = type (first_name)  # The type of first_name is shown to be str.
...
def exercise06():
    ...
    hours_worked = 20
    wage_per_hour = 15
    total_pay = hours_worked * wage_per_hour  # hours are multiplied by hourly wage
...
def exercise08():
    ...
    quantity = 5
    hello = "hello"
    hello_repeated = hello * quantity  # Multiplication works differently with strings.
...
def exercise09():
    ...
    qty = 10
    price = 5
    total_cost = qty * price    # This multiplies quantity and price.
    # ------ Place code above here /\ /\ /\ ------
...
def exercise10():
    ...
    """This multiplies 5 numbers. An earlier function called reduce has been deprecated."""
...
def exercise12():
    ...
    # ------ Place code below here \/ \/ \/ ------
    x = 10
    y = 10 ** 7 # calculate 10 to the 7th power
    # ------ Place code above here /\ /\ /\ ------
    return x, y
...
def exercise13():
    ...
    # ------ Place code below here \/ \/ \/ ------
    r = 7
    volume_sphere = 4/3 * pi * r **3   # This calculates the volume of a sphere with radius 7.
...
def exercise14():
    ...
    length = 50
    height = 10.2
    area = length * height # This calculates the area of something that's 50 by 10.2
    area_type = type(area)
...
def exercise15():
    ...
    speed_mph = 80
    duration = 3
    distance = speed_mph * duration # This is how far a car goes at 80 mph in 3 hours.
...
def exercise16():
    ...
    b = 684
    c = math.sqrt(a ** 2 + b ** 2)
    ''' This calculates the hypotenuse of a triangle with sides that are a Pythagorean triple.'''
